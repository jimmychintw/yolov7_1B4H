...
## Status: COMPLETED ✅
    ...
    # 保存報告
    with open('multihead/validation/step4_analysis.txt', 'w') as f:
        f.write(report)
    
    print("\nAnalysis saved to multihead/validation/step4_analysis.txt")

if __name__ == "__main__":
    analyze_step4_changes()